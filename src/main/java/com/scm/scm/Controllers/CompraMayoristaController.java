...
public class CompraMayoristaController {
    ...
    public String realizarCompraMayorista(CompraMayorista compraMayorista, Model model){
    ...
    public String cancelCompra(@RequestParam(name = "folioComp", required = true)String folioComp){
