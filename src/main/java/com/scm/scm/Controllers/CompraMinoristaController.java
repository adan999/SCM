...
public class CompraMinoristaController {
    ...
    public String realizarCompraMinorista(CompraMinorista compraMinorista, Model model){
    ...
    public String cancelCompra(@RequestParam(name = "folioSegura", required = true)String folioSegura){
